...
class MF6xBase(TyreBase):
    """
    Class definition for the Magic Formula 6.1 and 6.2 tyre models. This class contains all the shared subsystems between
    ...
    References:
      ...
      2. Besselink, I.J.M. & Schmeitz, A.J.C. & Pacejka, H.B. (2010). *An improved Magic Formula/Swift tyre model that
      ...
      3. Besselink, I.J.M. & Schmeitz, A.J.C. & Pacejka, H.B. (2010). *An improved Magic Formula/Swift tyre model that
      ...
      5. International Organization for Standardization (2011). *Road vehicles -- Vehicle dynamics and road-holding
    ...
    def __init__(self, data, **settings):
        ...
        # run the initialization from the models class
    ...
    def find_forces(
        ...
        (SA, SL, FZ, N, P, IA, VX, PHIT,
         angle_unit) = self.process_inputs._process_data(SA=SA, SL=SL, FZ=FZ, N=N, P=P, IA=IA, VX=VX, PHIT=PHIT,
    ...
    def find_lateral_output(
        ...
        """
        Finds the free rolling outputs commonly used in lateral vehicle models. Order is ``FY``, ``MX``, ``MZ``,
        ``RL``, ``sigma_y``.
        ...
        (SA, _, FZ, N, P, IA, VX, PHIT,
         angle_unit) = self.process_inputs._process_data(SA=SA, SL=0.0, FZ=FZ, N=N, P=P, IA=IA, VX=VX, PHIT=PHIT,
                                                 angle_unit=angle_unit)
    ...
    def find_longitudinal_output(
        ...
        (_, SL, FZ, N, P, IA, VX, PHIT,
         angle_unit) = self.process_inputs._process_data(SA=0.0, SL=SL, FZ=FZ, N=N, P=P, IA=IA, VX=VX, PHIT=0.0,
                                                 angle_unit=angle_unit)
    ...
    def find_full_output(
        ...
        # store input signals inside a dataclass
        inputs = InputSignals(SA=SA, SL=SL, FZ=FZ, N=N, P=P, IA=IA, VX=VX, PHIT=PHIT)

        # pre-process the input signals
        #inputs_modified = self.common._preprocess_data(inputs, angle_unit=angle_unit)
        (SA, SL, FZ, N, P, IA, VX, PHIT,
         angle_unit) = self.process_inputs._process_data(SA=SA, SL=SL, FZ=FZ, N=N, P=P, IA=IA, VX=VX, PHIT=PHIT,
                                                 angle_unit=angle_unit)
        ...
        if self._use_mfeval_mode:
            ...
            output = [FX, FY, inputs.FZ, MX, MY, MZ, inputs.SL, inputs.SA, inputs.IA, inputs.PHIT, inputs.VX, inputs.P,
                      RE, rho, 2 * a, t, mu_x, mu_y, inputs.N, RL, 2 * b, MZR, Cx, Cy, Cz, KYA, sigma_x, sigma_y, iKYA,
                      KXK]
        else:
    ...
    def find_fx_pure(
        ...
        # pre-process the input tyres_example
        (_, SL, FZ, N, P, IA, VX, PHIT,
         angle_unit) = self.process_inputs._process_data(SA=0.0, SL=SL, FZ=FZ, N=N, P=P, IA=IA, VX=VX, PHIT=PHIT,
                                                 angle_unit=angle_unit)
    ...
    def find_my_pure(
        ...
        (_, SL, FZ, _, P, IA, VX, PHIT,
         angle_unit) = self.process_inputs._process_data(SA=0.0, SL=SL, FZ=FZ, N=0.0, P=P, IA=IA, VX=VX, PHIT=0.0,
                                                 angle_unit=angle_unit)
    ...
    def find_mu_x(
        ...
        (SA, SL, FZ, _, P, IA, VX, _,
         angle_unit) = self.process_inputs._process_data(SA=SA, SL=SL, FZ=FZ, N=0.0, P=P, IA=IA, VX=VX, PHIT=0.0,
                                                 angle_unit=angle_unit)
    ...
    def find_lateral_stiffness(
        ...
        # pre-process the input tyres_example
        (_, _, FZ, _, P, _, _, _,
         angle_unit) = self.process_inputs._process_data(SA=0.0, SL=0.0, FZ=FZ, N=0.0, P=P, IA=0.0, VX=None, PHIT=0.0,
                                                 angle_unit="rad")
    ...
    def find_longitudinal_stiffness(
        ...
        # pre-process the input tyres_example
        (_, _, FZ, _, P, _, _, _,
         _) = self.process_inputs._process_data(SA=0.0, SL=0.0, FZ=FZ, N=0.0, P=P, IA=0.0, VX=None, PHIT=0.0, angle_unit="rad")
    ...
    def find_vertical_stiffness(
        ...
        # pre-process the input tyres_example
        (_, _, _, _, P, _, _, _,
         _) = self.process_inputs._process_data(SA=0.0, SL=0.0, FZ=self.FNOMIN, N=0.0, P=P, IA=0.0, VX=self.LONGVL, PHIT=0.0,
                                        angle_unit="rad")
    ...
    def find_cornering_stiffness_instant(
        ...
        # pre-process the input tyres_example
        (SA, _, _, _, _, _, _, _,
         angle_unit) = self.process_inputs._process_data(SA=SA, SL=0.0, FZ=self.FNOMIN, N=0.0, P=self.INFLPRES, IA=0.0, VX=None,
                                                 PHIT=0.0, angle_unit=angle_unit)
    ...
    def find_slip_stiffness_instant(
        ...
        # pre-process the input tyres_example
        (_, SL, _, _, _, _, _, _,
         _) = self.process_inputs._process_data(SA=0.0, SL=SL, FZ=self.FNOMIN, N=0.0, P=self.INFLPRES, IA=0.0, VX=None,
    ...
    def find_longitudinal_relaxation(
        ...
        # pre-process the input tyres_example
        (_, _, FZ, _, P, _, _, _,
         _) = self.process_inputs._process_data(SA=0.0, SL=0.0, FZ=FZ, N=0.0, P=P, IA=0.0, VX=self.LONGVL, PHIT=0.0,
                                        angle_unit="rad")
