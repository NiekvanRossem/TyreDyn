...
# import subsystems
from tyredyn.subsystems.radius.radius_mf61 import RadiusMF61
...
class MF61(MF6xBase):
    ...
    def _create_radius_model(self):
        ...
        return RadiusMF61(self)

    @wraps(RadiusMF61._find_radius)
    def find_radius(
            self,
            FX: SignalLike,
            FY: SignalLike,
        ...
        (_, _, FZ, N, P, _, _, _,
         _) = self.common._process_data(SA=0.0, SL=0.0, FZ=FZ, N=N, P=P, IA=0.0, VX=None, PHIT=0.0, angle_unit="rad")
