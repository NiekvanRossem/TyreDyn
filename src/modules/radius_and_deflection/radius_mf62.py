...
class RadiusMF62:
    ...
    def _find_radius(
        ...
        for iteration in range(maxiter):
            ...
            y_newest = self.__find_fz(FX=FX, FY=FY, RL=RL_newest, R_omega=R_omega, N=N, dpi=dpi, IA=IA, FZ0=FZ0, R0=R0,
        ...
        # vertical deflection
        rho = self.__find_deflection(R_omega=R_omega, RL=RL, IA=IA)
