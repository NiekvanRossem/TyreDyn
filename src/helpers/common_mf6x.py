...
class CommonMF6x:
    ...
    def _find_omega(
        ...
        """Returns the angular speed of the wheel based on the longitudinal velocity."""
        ...
        # converge over N TODO: add convergence flags and filter
        while np.max(err) > 1e-9:
            counter += 1
            ...
            if counter > 100:  # TODO: make adjustable setting
                warnings.warn("No estimate for the angular speed found!")
                break
    ...
    def _preprocess_data(
        ...
        # correct angle if mismatched between input array and TIR file TODO: add N and maybe PHIT
        [SA, IA], angle_unit = self._angle_unit_check([SA, IA], angle_unit=angle_unit)
