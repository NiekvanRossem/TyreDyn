...
class MF62(TyreBase):
    ...
    def find_force_moment(
        ...
        [FX, FY, FZ] = self.find_forces(SA=SA, SL=SL, FZ=FZ, P=P, IA=IA, VCX=VCX, VS=VS, PHI=PHI, angle_unit=angle_unit)
        [MX, MY, MZ] = self.find_moments(SA=SA, SL=SL, FZ=FZ, VX=VX, P=P, IA=IA, VC=VC, VCX=VCX, VS=VS, PHI=PHI, angle_unit=angle_unit)
...
if __name__ == "__main__":
    ...
    [FX, FY, FZ,
     ...
     Cx, Cy, Cz,
     KYA, iKYA, KXK, iKXK,
     sigma_x, sigma_y] = tyre.find_full_output(SA, SL, FZ, VX, N, P=P, IA=IA, VC=None, VCX=None, VS=VS, PHI=PHI, angle_unit="deg")
